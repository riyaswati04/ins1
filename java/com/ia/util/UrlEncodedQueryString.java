 ...
 * <code>www-form-urlencoded</code> encoding scheme, as defined by
 * <a href="http://www.w3.org/TR/REC-html40/interact/forms.html#h-17.13.4.1">HTML 4.01
 * Specification: application/x-www-form-urlencoded</a>, and
 * <a href="http://www.w3.org/TR/1999/REC-html401-19991224/appendix/notes.html#h-B.2.2">HTML 4.01
 ...
 * <code>java.net.URLEncoder</code> and <code>java.net.URLDecoder</code>, which follow the
 * <a href="http://www.w3.org/TR/html40/appendix/notes.html#non-ascii-chars"> HTML 4.01
 * Specification: Non-ASCII characters in URI attribute values</a> recommendation.
...
public class UrlEncodedQueryString {
     ...
     * <p>
     * Recommended separators are defined by
     * <a href="http://www.w3.org/TR/REC-html40/interact/forms.html#h-17.13.4.1">HTML 4.01
     * Specification: application/x-www-form-urlencoded</a> and
     * <a href="http://www.w3.org/TR/html401/appendix/notes.html#h-B.2.2">HTML 4.01 Specification:
    ...
    public static enum Separator {
        /**
         * An ampersand <code>&amp;</code> - the separator recommended by
         * <a href="http://www.w3.org/TR/REC-html40/interact/forms.html#h-17.13.4.1">HTML 4.01
        ...
        AMPERSAND {
             ...
             * <p>
             * The String representation matches that defined by the
             * <a href="http://www.w3.org/TR/REC-html40/interact/forms.html#h-17.13.4.1">HTML 4.01
             * Specification: application/x-www-form-urlencoded</a>.
             */
        ...
        /**
         * A semicolon <code>;</code> - the separator recommended by
         * <a href="http://www.w3.org/TR/html401/appendix/notes.html#h-B.2.2">HTML 4.01
    ...
    private static final String PARSE_PARAMETER_SEPARATORS =
            String.valueOf(Separator.AMPERSAND) + Separator.SEMICOLON;
    ...
    public static UrlEncodedQueryString create(final Map<String, List<String>> parameterMap) {

        final UrlEncodedQueryString queryString = new UrlEncodedQueryString();
     ...
     * than once in the given string, it is stored as a multivalued parameter. When parsing, all
     * <a href="UrlEncodedQueryString.Separator.html">Separators</a> are recognised.
     *
    ...
    private void appendOrSet(final CharSequence parameters, final boolean append) {
        ...
        final StringTokenizer tokenizer =
                new StringTokenizer(parameters.toString(), PARSE_PARAMETER_SEPARATORS);
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            final int indexOf = parameter.indexOf('=');
    ...
    private void appendOrSet(final String name, final String value, final boolean append) {
        ...
        if (append) {
            final List<String> listValues = queryMap.get(name);
    ...
    public URI apply(final URI uri, final Separator separator) {
        ...
        final String query = toString(separator);
        if (query.length() != 0) {
            builder.append('?');
    ...
    public boolean equals(final Object obj) {
        ...
        final String thatQuery = ((UrlEncodedQueryString) obj).toString();
     ...
     * <a href="#getValues(java.lang.String)">getValues</a>.
     * <p>
    ...
    public String get(final String name) {
        ...
        final List<String> parameters = getValues(name);
    ...
    public Map<String, List<String>> getMap() {
        ...
        for (final Map.Entry<String, List<String>> entry : queryMap.entrySet()) {
            final List<String> listValues = entry.getValue();
     ...
     * given string, it is stored as a multivalued parameter. When parsing, all
     * <a href="UrlEncodedQueryString.Separator.html">Separators</a> are recognised.
     *
     * @param query <code>www-form-urlencoded</code> string. If <code>null</code>, does nothing
     * @return a reference to this object
     ...
     * <p>
     * The HTML specification recommends two parameter separators in
     * <a href="http://www.w3.org/TR/REC-html40/interact/forms.html#h-17.13.4.1">HTML 4.01
     * Specification: application/x-www-form-urlencoded</a> and
     * <a href="http://www.w3.org/TR/1999/REC-html401-19991224/appendix/notes.html#h-B.2.2">HTML
     * 4.01 Specification: Ampersands in URI attribute values</a>. Of those, the ampersand is the
     * more commonly used and this method defaults to that.
     *
    ...
    public String toString(final Separator separator) {

        final StringBuilder builder = new StringBuilder();

        for (final String name : queryMap.keySet()) {
            for (final String value : queryMap.get(name)) {
                if (builder.length() != 0) {
