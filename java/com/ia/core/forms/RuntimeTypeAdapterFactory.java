 ...
 * configurable.
 *
 * <h3>Registering Types</h3> Create a {@code RuntimeTypeAdapter} by passing the base type and type
 * field name to the {@link #of} factory method. If you don't supply an explicit type field name,
 ...
 * {
 *     &#064;code
 *     Gson gson = new GsonBuilder().registerTypeAdapter(Shape.class, shapeAdapter).create();
 * }
 * </pre>
 *
